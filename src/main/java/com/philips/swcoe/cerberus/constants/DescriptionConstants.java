...
public final class DescriptionConstants {
    ...
    public static final String CERBERUS_DESCRIPTION = "Waking Cerberus to devour bad things in the system";
    ...
    public static final String FILES_OPTION_NOT_NULL_ARGUMENT_MESSAGE = "Specify the absolute path to source code";
    public static final String CURRENT_FILES_OPTION_NOT_NULL_ARGUMENT_MESSAGE = "Specify the absolute path to your source code which has current version";
    ...
    public static final String CURRENT_FILES_CMD_LINE_OPTION_DESCRIPTION = "Absolute Path to your source code which has current version.";
