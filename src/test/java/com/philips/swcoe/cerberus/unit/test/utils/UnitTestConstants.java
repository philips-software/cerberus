...
public class UnitTestConstants {
    ...
    public static final String TEST_JAVA_CODE_PREVIOUS = TEST_JAVA_CODE + PATH_SEPARATOR +  "previous";
    ...
    public static final String COMMENTED_OUT_SUPPRESSED_WARNINGS_JAVA = "CommentedOutSuppressedWarnings";
    public static final String GENERIC_SUPPRESSED_WARNINGS_JAVA = "GenericSuppressedWarnings";
    public static final String MULTI_LINE_COMMENTED_SUPPRESSED_WARNINGS_JAVA = "MultiLineCommentedSuppressedWarnings";
    public static final String SONARQUBE_SUPPRESSED_WARNINGS_JAVA = "SonarQubeSuppressedWarnings";
    public static final String SUPPRESSED_WARNINGS_WITH_FULL_PACKAGE_NAME_JAVA = "SuppressedWarningWithFullPackageName";
